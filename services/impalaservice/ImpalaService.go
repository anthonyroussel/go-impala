...
func (p *ImpalaHiveServer2ServiceClient) ResetCatalog(ctx context.Context) (_r *status.TStatus, _err error) {
  var _args76 ImpalaHiveServer2ServiceResetCatalogArgs
  var _result78 ImpalaHiveServer2ServiceResetCatalogResult
  var _meta77 thrift.ResponseMeta
  _meta77, _err = p.Client_().Call(ctx, "ResetCatalog", &_args76, &_result78)
...
func NewImpalaHiveServer2ServiceProcessor(handler ImpalaHiveServer2Service) *ImpalaHiveServer2ServiceProcessor {
  self80 := &ImpalaHiveServer2ServiceProcessor{cli_service.NewTCLIServiceProcessor(handler)}
  self80.AddToProcessorMap("ResetCatalog", &impalaHiveServer2ServiceProcessorResetCatalog{handler:handler})
  return self80
}
